    ...
    <header className='w-full fixed z-10 bg-black opacity-90'>
      <nav className="flex w-full py-2 md:py-3 px-4 md:px-20 items-center justify-between">
          <a href="/" className='flex items-center justify-center text-white text-lg cursor-pointer'>
            <img src={Logo} alt="logo" className='hidden md:block w-8 h-8 lg:w-14'/>
          ...
          <Button title='Sign in' conteinarStyle = "hidden md:block bg-transparent border border-white text-white hover:bg-white hover:text-slate-700 rounded-full min-w-[130px]"/>
